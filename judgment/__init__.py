...
_MAP = {
    ...
    "_trigger_correlation_memory": ("closed_loop", "_trigger_correlation_memory"),
    ...
    "get_cases": ("self_evolver", "get_cases"),

    "get_collection_status": ("verdict_collector", "get_collection_status"),

    "get_conn": ("self_evolver", "get_conn"),
    ...
    "get_scheduler": ("self_evolver", "get_scheduler"),
